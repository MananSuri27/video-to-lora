...
echo "[gpu] 6-run using CUDA_VISIBLE_DEVICES=${CUDA_VISIBLE_DEVICES}"
export PYTORCH_CUDA_ALLOC_CONF="${PYTORCH_CUDA_ALLOC_CONF:-expandable_segments:True}"
echo "[gpu] 6-run using PYTORCH_CUDA_ALLOC_CONF=${PYTORCH_CUDA_ALLOC_CONF}"
...
echo "[gpu] 6-run using CUDA_HOME=${CUDA_HOME}"
...
WANDB_GROUP="${WANDB_GROUP:-msrvtt-qa-canonical-video-centric-kl}"
WANDB_RUN_NAME="${WANDB_RUN_NAME:-msrvtt-qa-canonical-kl-qpv${QUESTIONS_PER_VIDEO}-f${MAX_FRAMES}-r${LORA_R}-bs${BATCH_SIZE}}"

TRAIN_MANIFEST="/data/video2lora/processed/msrvtt-qa-canonical-train.jsonl"
VAL_MANIFEST="/data/video2lora/processed/msrvtt-qa-canonical-val.jsonl"
